...
from IPython.utils.traitlets import Unicode, Int # Import the base Widget class and the traitlets Unicode class.
...
class ForceDirectedGraphWidget(widgets.DOMWidget):
    ...
    width = Int(400, sync=True)
    height = Int(300, sync=True)
